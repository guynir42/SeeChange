...
def upgrade() -> None:
    ...
    op.add_column('cutouts', sa.Column('format', sa.Enum('fits', 'hdf5', 'csv', 'npy', name='file_format', create_type=False), nullable=False))
    ...
    op.add_column('source_lists', sa.Column('format', sa.Enum('fits', 'hdf5', 'csv', 'npy', name='file_format', create_type=False), nullable=False))
