...
Revision ID: 7b978ec94e53
Revises: 
Create Date: 2023-05-05 15:24:55.045080
...
def upgrade() -> None:
    ...
    sa.Column('aperture', sa.Float(), nullable=False),
    sa.Column('focal_ratio', sa.Float(), nullable=False),
    sa.Column('pixel_scale', sa.Float(), nullable=False),
    sa.Column('square_degree_fov', sa.Float(), nullable=False),
    sa.Column('read_time', sa.Float(), nullable=False),
    sa.Column('read_noise', sa.Float(), nullable=False),
    sa.Column('dark_current', sa.Float(), nullable=False),
    sa.Column('gain', sa.Float(), nullable=False),
    sa.Column('saturation_limit', sa.Float(), nullable=False),
    sa.Column('non_linearity_limit', sa.Float(), nullable=False),
    sa.Column('allowed_filters', sa.ARRAY(sa.String()), nullable=False),
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('modified', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'telescope', name='_instrument_name_telescope_uc')
    )
    ...
    sa.CheckConstraint(sqltext='NOT(filter IS NULL AND filter_array IS NULL)', name='exposures_filter_or_array_check'),
