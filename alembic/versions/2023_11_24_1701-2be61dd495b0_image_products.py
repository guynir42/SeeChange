...
Revision ID: 2be61dd495b0
Revises: aae2097b2750
Create Date: 2023-11-24 17:01:17.866654
...
def upgrade() -> None:
    ...
    sa.Column('psf_id', sa.BigInteger(), nullable=True),
    sa.Column('sources_id', sa.BigInteger(), nullable=True),
    sa.Column('wcs_id', sa.BigInteger(), nullable=True),
    sa.Column('zp_id', sa.BigInteger(), nullable=True),
    sa.Column('mjd', sa.Float(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('modified', sa.DateTime(), nullable=False),
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['image_id'], ['images.id'], name='image_products_image_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['psf_id'], ['psfs.id'], name='image_products_psf_id_fkey'),
    sa.ForeignKeyConstraint(['sources_id'], ['source_lists.id'], name='image_products_source_list_id_fkey'),
    sa.ForeignKeyConstraint(['wcs_id'], ['world_coordinates.id'], name='image_products_wcs_id_fkey'),
    sa.ForeignKeyConstraint(['zp_id'], ['zero_points.id'], name='image_products_zp_id_fkey'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_image_products_created_at'), 'image_products', ['created_at'], unique=False)
    op.create_index(op.f('ix_image_products_id'), 'image_products', ['id'], unique=False)
    op.create_index(op.f('ix_image_products_image_id'), 'image_products', ['image_id'], unique=False)
    op.create_index(op.f('ix_image_products_mjd'), 'image_products', ['mjd'], unique=False)
    op.create_index(op.f('ix_image_products_psf_id'), 'image_products', ['psf_id'], unique=False)
    op.create_index(op.f('ix_image_products_sources_id'), 'image_products', ['sources_id'], unique=False)
    op.create_index(op.f('ix_image_products_wcs_id'), 'image_products', ['wcs_id'], unique=False)
    op.create_index(op.f('ix_image_products_zp_id'), 'image_products', ['zp_id'], unique=False)
    op.create_table('image_products_association',
    sa.Column('prod_id', sa.Integer(), nullable=False),
    sa.Column('image_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['image_id'], ['images.id'], name='image_products_association_image_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['prod_id'], ['image_products.id'], name='image_products_association_prod_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('prod_id', 'image_id')
    )
    ...
    sa.Column('modified', sa.DateTime(), nullable=False),
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['products_id'], ['image_products.id'], name='references_image_products_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_references_products_id'), 'references', ['products_id'], unique=False)
    ...
    op.add_column('images', sa.Column('ref_products_id', sa.Integer(), nullable=True))
    op.add_column('images', sa.Column('new_products_id', sa.Integer(), nullable=True))
    ...
    op.create_index(op.f('ix_images_new_products_id'), 'images', ['new_products_id'], unique=False)
    op.create_index(op.f('ix_images_ref_products_id'), 'images', ['ref_products_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_images_ref_products_id'), table_name='images')
    op.drop_index(op.f('ix_images_new_products_id'), table_name='images')
    ...
    op.drop_column('images', 'new_products_id')
    op.drop_column('images', 'ref_products_id')
    ...
    op.drop_index(op.f('ix_references_products_id'), table_name='references')
    ...
    op.drop_table('image_products_association')
    op.drop_index(op.f('ix_image_products_zp_id'), table_name='image_products')
    op.drop_index(op.f('ix_image_products_wcs_id'), table_name='image_products')
    op.drop_index(op.f('ix_image_products_sources_id'), table_name='image_products')
    op.drop_index(op.f('ix_image_products_psf_id'), table_name='image_products')
    op.drop_index(op.f('ix_image_products_mjd'), table_name='image_products')
    op.drop_index(op.f('ix_image_products_image_id'), table_name='image_products')
    op.drop_index(op.f('ix_image_products_id'), table_name='image_products')
    op.drop_index(op.f('ix_image_products_created_at'), table_name='image_products')
